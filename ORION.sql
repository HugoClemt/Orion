...
--
-- Client :  localhost
-- Généré le :  Jeu 25 Mars 2021 à 14:58
...
--
-- Contenu de la table `piecejoint`
--
...
ALTER TABLE `affectation`
 ADD PRIMARY KEY (`idCourriel`,`idPieceJoint`), ADD KEY `idPieceJoint` (`idPieceJoint`);
...
--
ALTER TABLE `cheval`
 ADD PRIMARY KEY (`id`), ADD KEY `idTypeCheval` (`idTypeCheval`), ADD KEY `idClient` (`idClient`), ADD KEY `pere` (`pere`,`mere`), ADD KEY `mere` (`mere`);

--
-- Index pour la table `client`
--
ALTER TABLE `client`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_cli_pays` (`codePays`), ADD KEY `idVendeur` (`idVendeur`);
...
ALTER TABLE `courriel`
 ADD PRIMARY KEY (`id`), ADD KEY `FK_VENTE_COURRIEL` (`idVente`);
...
--
ALTER TABLE `lot`
 ADD PRIMARY KEY (`id`), ADD KEY `idCheval` (`idCheval`), ADD KEY `idVente` (`idVente`);
...
--
-- Index pour la table `piecejoint`
--
ALTER TABLE `piecejoint`
 ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `vendeur`
 ADD PRIMARY KEY (`idClient`,`idCheval`), ADD KEY `idCheval` (`idCheval`);

--
-- Index pour la table `vente`
--
ALTER TABLE `vente`
 ADD PRIMARY KEY (`id`), ADD KEY `codeCategVente` (`codeCategVente`), ADD KEY `idLieu` (`idLieu`);
...
--
ALTER TABLE `vente`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1321570;
--
